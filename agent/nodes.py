...
# LLM-only findings (SQL injection, eval, deserialization) have no safety net —
# Mistral under-reports these inconsistently. This regex floor guarantees
# well-known dangerous one-liners are always caught, language-agnostic.
